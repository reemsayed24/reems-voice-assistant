...
st.set_page_config(page_title="ReeM's Voice Assistant", page_icon="🎙️", layout="wide")

st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600&family=Inter:wght@300;400;500&display=swap');
html, body, .stApp { background-color: #f5f0eb; font-family: 'Inter', sans-serif; }
section[data-testid="stSidebar"] { background-color: #ede8e2; border-right: 1px solid #d6cfc7; }
h1 { font-family: 'Playfair Display', serif; color: #6b2737; font-size: 2.2rem; margin-bottom: 0; }
.subtitle { color: #9e8f83; font-size: 0.85rem; margin-top: 2px; margin-bottom: 24px; font-weight: 300; letter-spacing: 0.05em; }
.user-msg { background-color: #e8e0d8; color: #3a2f2a; padding: 14px 18px; border-radius: 16px 16px 4px 16px; margin: 8px 0; font-size: 0.95rem; line-height: 1.6; border-left: 3px solid #c4a882; }
.ai-msg { background-color: #6b2737; color: #f9f4ef; padding: 14px 18px; border-radius: 16px 16px 16px 4px; margin: 8px 0; font-size: 0.95rem; line-height: 1.6; }
